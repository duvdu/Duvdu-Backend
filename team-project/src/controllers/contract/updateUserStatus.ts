import { NotFound, TeamProject, UserStatus } from '@duvdu-v1/duvdu';
...
export const updateUserStatus = async (
  ...
  if (!team) throw new NotFound({ en: 'team not found', ar: 'التيم غير موجود' }, lang);
  ...
  if (userIndex === -1)
    throw new NotFound(
      { en: 'creative not found in this team', ar: 'المبدع غير موجود في هذا الفريق' },
      lang,
    );
