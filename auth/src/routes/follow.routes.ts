...
router.get('/user-follower' , isauthenticated , globalPaginationMiddleware , handler.getFollowersHandler);
router.get('/user-following' , isauthenticated , globalPaginationMiddleware , handler.getFollowingHandler);
