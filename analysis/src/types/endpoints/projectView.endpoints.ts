import { IProjectReview, PaginationResponse, SuccessResponse } from '@duvdu-v1/duvdu';
...
export interface UpdateProjectViewHandler
extends RequestHandler<{reviewId:string} , SuccessResponse<{data:IProjectReview}> , Partial<Pick<IProjectReview , 'comment' | 'rate'>> , unknown>{}
