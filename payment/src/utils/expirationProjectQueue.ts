...
export const createQueues = async () => {
  ...
  const onGoingExpiration = new Queue<IcontarctQueue>('onGoingExpiration-contract-pending', {
    connection: bullRedis,
  });
  ...
  return { updateAfterFirstPaymentQueue, onGoingExpiration };
};
...
export const getUpdateAfterFirstPaymentQueue = () => queues?.updateAfterFirstPaymentQueue;
