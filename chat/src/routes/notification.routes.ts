...
router
  .route('/users')
  .post(
    isauthorized(PERMISSIONS.sendNotificationToUsers),
    val.sendMultiNotificationVal,
    handler.sendNotificationToMultiUserHandler,
  );
router
  .route('/')
  .get(
  ...
  .post(
    isauthorized(PERMISSIONS.sendNotificationToUsers),
    val.sendTopicNotificationVal,
    handler.sendTopicNotificationHandler,
  );
