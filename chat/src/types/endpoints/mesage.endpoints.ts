...
export interface SendMessageHandler
  extends RequestHandler<
    unknown,
    SuccessResponse<{ data: ImessageDoc }>,
    Partial<Pick<ImessageDoc, 'content' | 'receiver'>>,
    unknown
  > {}
...
export interface UpdateMessageHandler
  extends RequestHandler<
    { message: string },
    SuccessResponse<{ data: ImessageDoc }>,
    Partial<Pick<ImessageDoc, 'content' | 'reactions'>>,
    unknown
  > {}
...
export interface GetChatFromUserToUserHandler
  extends RequestHandler<
    ...
    PaginationResponse<{ data: ImessageDoc[] }>,
    unknown,
    { limit?: number; page?: number; toDate?: Date; fromDate?: Date }
  > {}
